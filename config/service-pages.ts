...
export const servicePages: ServiceLandingPage[] = [
  ...
  {
    slug: "microwave-oven-repair-bhilai-near-me",
    serviceId: "oven-microwave-repair",
    h1En: "Microwave & Oven Repair in Bhilai",
    h1Hi: "भिलाई में माइक्रोवेव और ओवन रिपेयर",
    metaTitle: "Microwave & Oven Repair in Bhilai | Heating & Timer Faults",
    metaDescription:
      "Microwave and oven repair in Bhilai — not heating, plate not rotating, sparking, timer, door and control panel faults diagnosed and fixed. Junwani Road shop. Call 91099 18786.",
    keywords: [
      "microwave repair Bhilai",
      "microwave repair near me",
      "oven repair Bhilai",
      "microwave not heating",
      "otg repair Bhilai",
      "microwave repair shop Bhilai",
      "माइक्रोवेव रिपेयर भिलाई",
    ],
    introEn: [
      "A microwave that runs but doesn't heat, a plate that stopped rotating, sparking inside the cavity, or buttons that no longer respond — these are the faults we see most, and each has a known cause that can be diagnosed quickly at our Junwani Road shop.",
      "We repair microwaves, OTGs and ovens of all major brands, whether or not they were bought from us. Heating and sparking faults are safety issues, so stop using the machine and bring it in — running it further can turn a small part replacement into a bigger job.",
    ],
    introHi: [
      "माइक्रोवेव चलता है पर गर्म नहीं करता, प्लेट घूमना बंद हो गई, अंदर चिंगारी दिखती है, या बटन काम नहीं करते — यही खराबियाँ हमारे पास सबसे ज़्यादा आती हैं, और हर एक की जानी-पहचानी वजह होती है जो जुनवानी रोड की हमारी दुकान पर जल्दी पकड़ में आ जाती है।",
      "हम सभी बड़े ब्रांड के माइक्रोवेव, OTG और ओवन रिपेयर करते हैं — चाहे वे हमसे खरीदे गए हों या नहीं। हीटिंग और चिंगारी की खराबी सुरक्षा का मामला है, इसलिए मशीन चलाना बंद करके दुकान पर लाएँ — और चलाने से छोटे पार्ट का काम बड़ा बन सकता है।",
    ],
    workEn: [
      "Not-heating fault diagnosis and repair",
      "Turntable plate and motor repair",
      "Sparking / arcing inside cavity",
      "Door, latch and hinge repair",
      "Timer and control panel faults",
      "Fuse and power problems",
      "OTG heating element replacement",
      "Full safety check after repair",
    ],
    workHi: [
      "गर्म न करने की खराबी की जाँच और रिपेयर",
      "घूमने वाली प्लेट और मोटर की रिपेयर",
      "अंदर चिंगारी / आर्किंग की समस्या",
      "दरवाज़ा, लैच और हिंज रिपेयर",
      "टाइमर और कंट्रोल पैनल की खराबी",
      "फ्यूज़ और पावर की समस्या",
      "OTG हीटिंग एलिमेंट बदलना",
      "रिपेयर के बाद पूरी सुरक्षा जाँच",
    ],
    faqs: [
      {
        qEn: "My microwave runs but food stays cold — is it worth repairing?",
        aEn: "Usually yes. A not-heating fault most often traces to one replaceable part, and the repair typically costs far less than a new machine. We diagnose it first and tell you the cost before any work.",
        qHi: "माइक्रोवेव चलता है पर खाना ठंडा रहता है — क्या रिपेयर कराना सही रहेगा?",
        aHi: "आमतौर पर हाँ। गर्म न करने की खराबी ज़्यादातर एक बदले जा सकने वाले पार्ट तक जाती है, और रिपेयर नई मशीन से कहीं सस्ती पड़ती है। हम पहले जाँच करके काम से पहले खर्च बता देते हैं।",
      },
      {
        qEn: "There is sparking inside my microwave — can I keep using it?",
        aEn: "No — stop using it. Sparking usually means a damaged waveguide cover or internal part, and continued use can damage the magnetron. Bring it in for a check before running it again.",
        qHi: "माइक्रोवेव के अंदर चिंगारी दिखती है — क्या इस्तेमाल जारी रख सकते हैं?",
        aHi: "नहीं — इस्तेमाल बंद कर दें। चिंगारी का मतलब आमतौर पर खराब वेवगाइड कवर या अंदर का पार्ट होता है, और चलाते रहने से मैग्नेट्रॉन खराब हो सकता है। दोबारा चलाने से पहले जाँच के लिए लाएँ।",
      },
      {
        qEn: "Do you repair OTGs and electric ovens too?",
        aEn: "Yes — OTG heating elements, thermostats, timers and trays are all handled at the shop, for all major brands.",
        qHi: "क्या आप OTG और इलेक्ट्रिक ओवन भी रिपेयर करते हैं?",
        aHi: "हाँ — OTG के हीटिंग एलिमेंट, थर्मोस्टेट, टाइमर और ट्रे का काम दुकान पर होता है, सभी बड़े ब्रांड के लिए।",
      },
    ],
    relatedBlogSlugs: [],
  },
  {
    slug: "iron-repair-bhilai-near-me",
    serviceId: "iron-repair",
    h1En: "Iron Repair in Bhilai",
    h1Hi: "भिलाई में इस्त्री रिपेयर",
    metaTitle: "Iron Repair in Bhilai | Dry & Steam Iron Service",
    metaDescription:
      "Dry and steam iron repair in Bhilai — not heating, overheating, cord and thermostat faults fixed with genuine parts at our Junwani Road shop. Call 91099 18786.",
    keywords: [
      "iron repair Bhilai",
      "iron repair near me",
      "steam iron repair Bhilai",
      "iron not heating",
      "press repair Bhilai",
      "electric iron repair shop Bhilai",
      "इस्त्री रिपेयर भिलाई",
    ],
    introEn: [
      "An iron that doesn't heat, heats too much, trips the MCB or has a frayed cord is a quick fix in most cases — the element, thermostat and cord are all standard replaceable parts. We repair dry and steam irons of all brands at our Junwani Road shop, usually the same day.",
      "A frayed or taped-up cord on an iron is a genuine shock hazard, especially in a home with children. Cord replacement is one of the cheapest repairs we do — don't put it off.",
    ],
    introHi: [
      "इस्त्री गर्म नहीं होती, ज़्यादा गर्म होती है, MCB गिरा देती है या तार घिस गया है — ज़्यादातर मामलों में यह जल्दी ठीक होने वाला काम है, क्योंकि एलिमेंट, थर्मोस्टेट और तार सब बदले जा सकने वाले सामान्य पार्ट हैं। जुनवानी रोड की हमारी दुकान पर हर ब्रांड की ड्राई और स्टीम इस्त्री रिपेयर होती है, अक्सर उसी दिन।",
      "घिसा या टेप लगा तार सच में करंट का खतरा है, खासकर बच्चों वाले घर में। तार बदलना हमारी सबसे सस्ती रिपेयर में से एक है — इसे टालें नहीं।",
    ],
    workEn: [
      "Heating element replacement",
      "Thermostat repair (overheating / not heating)",
      "Cord and plug replacement",
      "Steam function and water leakage repair",
      "Indicator light and wiring faults",
      "Soleplate cleaning",
    ],
    workHi: [
      "हीटिंग एलिमेंट बदलना",
      "थर्मोस्टेट रिपेयर (ज़्यादा गर्म / गर्म न होना)",
      "तार और प्लग बदलना",
      "स्टीम फंक्शन और पानी लीक की रिपेयर",
      "इंडिकेटर लाइट और वायरिंग की खराबी",
      "सोलप्लेट की सफाई",
    ],
    faqs: [
      {
        qEn: "Is an old iron worth repairing or should I buy new?",
        aEn: "If the body and soleplate are fine, repair is almost always cheaper — element, thermostat and cord are inexpensive parts. If the soleplate is damaged or the body is cracked, we'll tell you honestly that a new one makes more sense; we sell Usha irons at the same counter.",
        qHi: "पुरानी इस्त्री रिपेयर कराना सही है या नई ले लूँ?",
        aHi: "अगर बॉडी और सोलप्लेट ठीक हैं, तो रिपेयर लगभग हमेशा सस्ती पड़ती है — एलिमेंट, थर्मोस्टेट और तार सस्ते पार्ट हैं। सोलप्लेट खराब हो या बॉडी चटकी हो, तो हम ईमानदारी से बता देंगे कि नई लेना बेहतर है; उसी काउंटर पर उषा इस्त्री मिलती भी है।",
      },
      {
        qEn: "My iron gives a small current / shock — what should I do?",
        aEn: "Stop using it immediately. That points to a wiring or earthing fault inside — a quick, inexpensive repair, but dangerous to ignore. Bring it to the shop for a check.",
        qHi: "इस्त्री में हल्का करंट आता है — क्या करूँ?",
        aHi: "तुरंत इस्तेमाल बंद कर दें। यह अंदर वायरिंग या अर्थिंग की खराबी की निशानी है — रिपेयर जल्दी और सस्ती है, पर नज़रअंदाज़ करना खतरनाक। जाँच के लिए दुकान पर लाएँ।",
      },
      {
        qEn: "How long does iron repair take?",
        aEn: "Common faults — element, cord, thermostat — are usually fixed the same day if the part is in stock. Call 91099 18786 before coming and we'll confirm.",
        qHi: "इस्त्री रिपेयर में कितना समय लगता है?",
        aHi: "आम खराबियाँ — एलिमेंट, तार, थर्मोस्टेट — पार्ट स्टॉक में होने पर आमतौर पर उसी दिन ठीक हो जाती हैं। आने से पहले 91099 18786 पर कॉल करके पक्का कर लें।",
      },
    ],
    relatedBlogSlugs: [],
