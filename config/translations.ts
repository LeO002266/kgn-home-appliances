...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "repair.issue_placeholder": "e.g. Mixer grinder motor is not running",
  ...
  hi: {
    ...
    "repair.issue_placeholder": "जैसे: मिक्सर ग्राइंडर की मोटर नहीं चल रही",
