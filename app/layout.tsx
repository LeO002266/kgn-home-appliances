...
export const metadata: Metadata = {
  ...
  description:
    "Home appliance shop on Junwani Road, Bhilai — refrigerators, washing machines, gas stoves, water purifiers, geysers, mixer grinders, fans & kitchenware. Appliance repair, servicing & gas pipeline work. Call 91099-18786 for best price.",
  keywords: [
